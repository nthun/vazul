...
test_that("scramble_variables_rowwise works with grouping", {
  df <- data.frame(
    x = c(1, 2, 3, 4, 5, 6),
  ...
  set.seed(123)
  result <- scramble_variables_rowwise(df, c("x", "y", "z"), .groups = "group")
  ...
  # Check rowwise scrambling within each group
  # Group A rows
  expect_setequal(c(result$x[1], result$y[1], result$z[1]), c(1, 10, 100))
  expect_setequal(c(result$x[2], result$y[2], result$z[2]), c(2, 20, 200))
  expect_setequal(c(result$x[3], result$y[3], result$z[3]), c(3, 30, 300))
  
  # Group B rows  
  expect_setequal(c(result$x[4], result$y[4], result$z[4]), c(4, 40, 400))
  expect_setequal(c(result$x[5], result$y[5], result$z[5]), c(5, 50, 500))
  expect_setequal(c(result$x[6], result$y[6], result$z[6]), c(6, 60, 600))
})
